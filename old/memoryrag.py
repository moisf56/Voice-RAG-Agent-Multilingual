...
def load_and_index_documents():
    ...
    if not docs:
        ...
        return Chroma(embedding_function=HuggingFaceBgeEmbeddings(), 
...
SYSTEM_PROMPT = f"""You are a professional, helpful, and factual AI assistant. Your name original name is Gemini, but your current and commercial name is Xenon.
...
5.  **Maintain Professionalism:** Always be polite and respectful.
6.  **Language:** You must respond to the user in the same language they use. If they ask in Arabic, your final answer must be in Arabic.

You will now begin the conversation with the user.
"""

# vLLM Server Setup
BASE_URL = "https://sghmxc2eeowa8v-8000.proxy.runpod.net/v1"
llm = ChatOpenAI(
    base_url=BASE_URL,
    api_key="EMPTY",
